---
title: "HW02 - Stat 133, Fall 2016, Prof. Sanchez"
author: "Your Name"
...
The data for this assignment is `cereals.RData`.

Start a new session in RStudio, and make sure there's no 
saved objects:
```{r eval = FALSE}
rm(list = ls())
```
...
`cereals.RData` (from the github repository)
```r
