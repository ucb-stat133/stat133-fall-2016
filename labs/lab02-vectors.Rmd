---
title: "Lab 2 - Stat 133, Fall 2016"
...
Once you have some data objects to work with, the first step is to perform
an inspection of their characteristics. R has a handful of functions that
...
To do so, you use what is known __bracket notation__. This implies using 
