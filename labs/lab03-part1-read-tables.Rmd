---
title: "Lab 3 - Stat 133, Fall 2016"
...
- Packages to read data set from other software programs
...
to save it in your computer). To do this, you can use `download.file()`
and specify the url address, and the name of the file that will be created in
your computer. For instance, to save the abalone data file in your working 
