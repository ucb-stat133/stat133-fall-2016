...
\bi
  \item Row binding with \code{rbind()}
  \item Row binding works on vectors, matrices, and data frames
  \item \code{rbind()} requires matrices with same number of columns
  \item \code{rbind()} on vectors requires vectors of same length
