...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'doc2' not found}}\begin{alltt}
\hlkwd{is.list}\hlstd{(doc2)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'doc2' not found}}\end{kframe}
\end{knitrout}
