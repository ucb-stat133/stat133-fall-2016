...
\bi
 ...
 \item \code{justify} controls how padding takes place for strings. Takes the values \code{"left", "right", "centre", "none"}
\ei
...
\begin{alltt}
\hlcom{# elem1 in set10?}
\hlstd{elem1} \hlopt{%in%} \hlstd{set10}
\end{alltt}
\begin{verbatim}
## [1] TRUE
\end{verbatim}
\begin{alltt}
\hlcom{# elem2 in set10?}
\hlstd{elem2} \hlopt{%in%} \hlstd{set10}
\end{alltt}
\begin{verbatim}
## [1] FALSE
\end{verbatim}
